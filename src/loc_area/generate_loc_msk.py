...
if loc_polyg == 0:
   msk_loc = generate_loc_area_poly(bathy)
elif loc_polyg >= 4:
   msk_loc = generate_loc_area_grad(bathy, ds_grid, loc_isobt, loc_polyg)
else:
   msk_loc = generate_loc_area_dept(bathy, loc_isobt, loc_polyg)
...
if s2z_wghts:
   ...
   #weights = weighting_dist(msk_zones, a=2.7)
...
out_name = 'dep' + str(loc_isobt) + '_pol' + str(loc_polyg) + '_sig' + str(s2z_sigma) + '_itr' + str(s2z_itera)

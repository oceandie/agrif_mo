...
bathy_0 = bathy_0.isel({'x':slice(820,860), 'y':slice(800,860)})
...
bathy_1 = bathy_1.isel(x=slice(30, 160), y=slice(60, 270))
...
# PARENT MODEL
ax.contourf(land0.nav_lon, land0.nav_lat, land0,                 zdir='z', offset=0.8, colors='black')#, zorder=10)
p = ax.contourf(bathy_0.nav_lon, bathy_0.nav_lat, bathy_0, levels=lev, zdir='z', offset=0.8, cmap=cmap, vmin=0, vmax=6200)#, zorder=1)
...
print(f"Saving", end=": ")
plt.savefig("bathy_agrif-gosi10p0_zoom.png", bbox_inches="tight")
print("done")
plt.close()

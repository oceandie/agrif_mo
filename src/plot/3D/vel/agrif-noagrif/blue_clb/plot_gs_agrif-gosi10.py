...
mod_dir0 = '/scratch/dbruciaf/AGRIF/gs_orca12/u-dd982/'
mod_dir1 = '/scratch/dbruciaf/AGRIF/gs_orca12/u-dd748/'
...
for yyyy in range(2005,2008):
    ...
    for mm in range(1,13):
        ...
        Ugrd_0 = mod_dir0 + mod_stm + date_mod + '_grid-U.nc'
        Vgrd_0 = mod_dir0 + mod_stm + date_mod + '_grid-V.nc'
        Ugrd_1 = mod_dir1 + agr_stm + date_mod + '_grid-U.nc'
        Vgrd_1 = mod_dir1 + agr_stm + date_mod + '_grid-V.nc'
